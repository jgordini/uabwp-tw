<?php
/**
 * Title: News Feed - 3 Column Cards
 * Slug: uabwp-tw/news-feed-3-col
 * Description: Displays the latest posts as cards in a 3-column grid.
 ...
 */
?>
<!-- wp:query {"queryId":4,"query":{"perPage":6,"pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"ignore","inherit":false},"metadata":{"categories":["news"],"patternName":"uabwp-tw/news-feed-3-col","name":"News Feed - 3 Column Cards"},"className":"news-feed-3-col container mx-auto px-12 mt-16","layout":{"type":"default"}} -->
<div class="wp-block-query news-feed-3-col container mx-auto px-12 mt-16">
    <!-- wp:post-template {"className":"grid grid-cols-1 md:grid-cols-3 gap-10","layout":{"type":"default"}} -->
    ...
    <!-- wp:query-no-results -->
    <!-- wp:paragraph {"align":"center","className":"md:col-span-3","placeholder":"Add text or blocks that will display when a query returns no results."} -->
    <p class="has-text-align-center md:col-span-3">Sorry, no posts were found.</p>
    <!-- /wp:paragraph -->
    <!-- /wp:query-no-results -->
</div>
<!-- /wp:query -->