<?php
/**
 * Title: Two Column (1/3 + 2/3)
 * Slug: uabwp-tw/2col-one-third
 ...
 * Description: A responsive two-column layout (1/3 + 2/3) with text in the left column, and text plus buttons in the right column.
 * Viewport Width: 1340
 */
?>
