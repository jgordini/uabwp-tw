 ...
 * Viewport Width: 1386
 * Inserter: yes
 * Keywords: map, google map, location, address
 * Description: Embeds a Google Map centered on a specific address.
 */
?>
<!-- wp:html -->
...
function initMap() {
  ...
  geocoder.geocode({ 'address': address }, function(results, status) {
    if (status === 'OK') {
      ...
      mapElement.innerHTML = 'Error: Could not find the specified address. Please check API key and address.';
    }
  });
}
