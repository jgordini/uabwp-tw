<?php
/**
 * Title: Two Column (2/3 + 1/3)
 * Slug: uabwp-tw/2col-two-third
 * Categories: featured, columns, text, uab
 * Keywords: columns, text, content, button, thirds
 * Block Types: core/group, core/heading, core/paragraph, core/buttons
 * Description: A responsive two-column layout (2/3 + 1/3) with text in the left column, and text plus buttons in the right column.
 * Viewport Width: 1340
 */
?>
