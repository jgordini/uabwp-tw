        ...
        <div class="flex flex-col lg:flex-row gap-10">
            ...
            <div class="lg:w-2/3">
                ...
                <div class="mt-6 flex gap-4">
                    <a href="#"
                        class="not-prose inline-block bg-uab-green hover:bg-dragons-lair-green text-white px-6 py-2 rounded-md font-aktiv-grotesk text-base no-underline hover:no-underline whitespace-nowrap"><?php echo esc_html__('Learn More', 'uabwp-tw'); ?></a>
                    <a href="#"
                        class="not-prose inline-block border border-uab-green text-uab-green px-6 py-2 rounded-md hover:bg-uab-green hover:text-white transition-colors font-aktiv-grotesk text-base no-underline hover:no-underline whitespace-nowrap"><?php echo esc_html__('View Details', 'uabwp-tw'); ?></a>
                </div>
            </div>
