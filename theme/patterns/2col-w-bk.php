<?php
/**
 * Title: Two Column with Background
 * Slug: uabwp-tw/2col-w-bk
 * Categories: featured, columns, text, uab
 * Keywords: columns, text, content, background, button
 * Block Types: core/group, core/heading, core/paragraph, core/buttons
 * Description: A responsive two-column layout with text in the left column, and text plus a button in the right column, all on a light green background.
 * Viewport Width: 1340
 */
?>
        ...
        <div class="flex flex-col lg:flex-row gap-10">
            ...
            <div class="lg:w-1/2">
                ...
                <div class="mt-6 flex gap-4">
                    ...
                    <a href="#"
                        class="inline-block border border-uab-green text-uab-green px-6 py-2 rounded-md hover:bg-uab-green hover:text-white transition-colors font-aktiv-grotesk text-base no-underline hover:no-underline whitespace-nowrap"><?php echo esc_html__('Secondary Action', 'uabwp-tw'); ?></a>
                </div>
            </div>
