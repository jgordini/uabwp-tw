<?php
/**
 * Title: Grid Stack Left with Links
 * Slug: uabwp-tw/grid-stack-left-links
 * Categories: featured, grid, text, image, uab
 * Keywords: grid, columns, image, text, content, stack, left, feature, links
 * Block Types: core/group, core/heading, core/paragraph, core/image, core/buttons, core/list
 * Description: A responsive two-column layout with an image on the left and text content (pre-header, description, link list, button) on the right, stacking vertically on smaller screens.
 * Viewport Width: 1340
 */
?>
<div class="flex flex-col lg:flex-row lg:items-center gap-10 mb-12 max-w-7xl mx-auto px-6 sm:px-0">
    ...
    <div class="lg:w-1/2">
        ...
        <img src="<?php echo esc_url(get_template_directory_uri() . '/images/anthro-class.webp'); ?>" <?php // Placeholder image, update if needed ?> alt="<?php esc_attr_e('Placeholder image', 'uabwp-tw'); ?>"
