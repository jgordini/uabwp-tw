<?php
/**
 * Title: Two Column (2/3 + 1/3) with Background
 * Slug: uabwp-tw/2col-two-third-w-bk
 ...
 * Description: A responsive two-column layout (2/3 + 1/3) with text in the left column, and text plus buttons in the right column, on a light green background.
 * Viewport Width: 1340
 */
?>
